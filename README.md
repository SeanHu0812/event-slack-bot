...
**Deleting bot messages:** anyone can react **🗑️ (`:wastebasket:`)** on any Event-Bot
message, in any channel, to delete it. It only ever removes the bot's own messages — Slack
won't let `chat.delete` touch anyone else's.
